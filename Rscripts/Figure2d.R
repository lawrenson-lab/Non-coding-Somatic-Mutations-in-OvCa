...
for(i in selectedPlots){
  ...
  selectedSEs <- c(1:10, selectedSEs)
...
library(cowplot)
pdf(file = 'figures/Figure2d.pdf', width = 4*10/5, height = 7.5/4, compress = T)
plot_grid(plotlist = plot.list[c(2, 9, 12, 19)], align = 'hv', axis = 'btrl', nrow = 1, ncol = 4)
dev.off()
